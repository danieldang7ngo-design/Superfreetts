...
REGEXP_REALTIME_SIMPLE_TEMPLATE = r'.*<superfreetss-template\s+setting="(.*)"\s+version="([a-z1-9]*)"[^>]*>(.*)</superfreetss-template>.*'
REGEXP_REALTIME_ADVANCED_TEMPLATE = r'.*<superfreetss-template-advanced\s+setting="(.*)"\s+version="([a-z1-9]*)"[^>]*>\n(.*)</superfreetss-template-advanced>.*'
