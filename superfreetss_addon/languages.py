...
def get_audio_lang_from_mms(mms_code: str):
    """Maps MMS 3-letter codes to AudioLanguage enum."""
    mapping = {
        "eng": AudioLanguage.en_US,
        "kor": AudioLanguage.ko_KR,
        "jpn": AudioLanguage.ja_JP,
        "cmn": AudioLanguage.zh_CN,
        "swe": AudioLanguage.sv_SE,
        "vie": AudioLanguage.vi_VN,
        "fra": AudioLanguage.fr_FR,
        "deu": AudioLanguage.de_DE,
        "spa": AudioLanguage.es_ES,
        "yue": AudioLanguage.zh_HK,
    }
    return mapping.get(mms_code.lower())
